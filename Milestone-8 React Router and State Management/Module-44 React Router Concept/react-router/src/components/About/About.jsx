...
const About = () => {
    return (
        <div className="my-10 max-w-300 mx-auto">
            <figure className="diff aspect-16/9" tabIndex={0}>
                ...
                <div className="diff-item-2" role="img">
                    <div className="bg-base-200 grid place-content-center text-9xl font-black">P&U</div>
                </div>
                <div className="diff-resizer"></div>
            </figure>
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mx-4">
                <AboutCard />
                <AboutCard />
                <AboutCard />
            </div>
